...
public class AbandonedQA_Baggage_Test_Case {

    WebDriver driver;
    Random r = new Random();
    String AWB=String.format("%04d", r.nextInt(1001));
    ...
    String SRC="C:\\java_Eclipes\\Intellij_code\\ScreenShot\\Abandoned\\reports";
...
//        option.addArguments("--headless");
        ...
        Thread.sleep(5000);
        report = new ExtentReports("C:\\java_Eclipes\\Intellij_code\\ScreenShot\\Abandoned\\reports\\AbandonedBaggage.html");
        test = report.startTest("Abandoned Baggage TestCase");
    }
    ...
    public void CreateAcceptAbandoned() throws InterruptedException, IOException {
        ...
        page.SearchAcceptAbandonedCargoBaggage(AWB);
        ...
        FileUtils.copyFile(src, new File(SRC+"baggage.png"));
    }
    ...
    public void CreateShipmentSorting() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"sorting.png"));
    ...
    public void RecordMerchandise() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"record.png"));
        if(result.equals("Operation Completed Successfully.")){
            test.log(LogStatus.PASS, "Record Merchandise is Created");
        }
        else{
            test.log(LogStatus.FAIL,"Error is showing in Record merchandise");
            driver.close();
        }
    }
    ...
    public void RecordEDTDetails() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"edt.png"));
        if(result.equals("Operation Completed Successfully.")){
    ...
    public void RequestItemSegregation() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"Segg.png"));
        if(result.equals("Operation Completed Successfully.")){
    ...
    public void CreateAuctionLot() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"Auction.png"));
        if(result.equals("Operation Completed Successfully.")){
    ...
    public void ReleaseMerchandise() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"Release.png"));
        if(result.equals("Operation Completed Successfully.")){
    ...
    public void CaptureDelivery() throws InterruptedException, IOException {
        ...
        String result = element.getAttribute("innerText");
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"delivery.png"));
        if(result.equals("Operation Completed Successfully.")){
    ...
    public void EnquireAbandonedCargo() throws InterruptedException, IOException {
        ...
        File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(src, new File(SRC+"enquire.png"));
